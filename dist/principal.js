...
const persona1 = new Cl_persona("Luisa", "F");
const persona2 = new Cl_persona("Ana", "F");
const persona3 = new Cl_persona("Jose", "M");
const persona4 = new Cl_persona("Carmen", "F");
const persona5 = new Cl_persona("Rosa", "F");
const persona6 = new Cl_persona("Jose", "M");
const persona7 = new Cl_persona("Maria", "F");
const persona8 = new Cl_persona("Luz", "F");
const persona9 = new Cl_persona("Rafael", "M");
const persona10 = new Cl_persona("Luz", "F");
const persona11 = new Cl_persona("Marcos", "M");
const persona12 = new Cl_persona("Leo", "M");
const contador = new Cl_contador();
...
if (body)
    body.innerHTML = `Cantidad de personas:${contador.totalPersonas()}
